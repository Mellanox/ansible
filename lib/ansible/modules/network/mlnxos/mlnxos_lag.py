...
short_description: Manage link aggregation groups on Mellanox MLNXOS network devices
description:
  - This module provides declarative management of link aggregation groups
    on Mellanox MLNXOS network devices.
options:
  name:
    description:
...
class MlnxosLagApp(BaseMlnxosModule):

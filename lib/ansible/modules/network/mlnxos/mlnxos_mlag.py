...
short_description: Manage MLags on MLNX-OS network devices
description:
  - >-
      This module provides declarative management of MLags
...
class MlnxosMLagApp(BaseMlnxosModule):
    ...
    def get_lag_members(cls, lag_item):
        lag_members = ""
        for attr, val in iteritems(lag_item):
